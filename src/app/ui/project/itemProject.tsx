...
export function ItemProject({ item, home }: Props) {
  ...
  return (
    <div className={`${home ? 'flex-1': 'w-64'} h-36 border border-neutral-600 rounded-lg p-3 relative`}>

      <h2 className="font-semibold text-xs border-b border-neutral-400 mb-3">{item.name}</h2>
